...
<body>
	<div class="w3-top">
		<nav>
			<ul class="w3-navbar w3-blue w3-card-2 w3-medium  "
				style="opacity: 0.9">
				<li><a href="Welcomepage"
					class="w3-hover-none w3-text-sand w3-hover-text-white"><i
						class="fa fa-home"></i> BIBLIO </a></li>
				<c:choose>
			...
			<c:choose>
				<c:when test="${!Administrator}">
					...
					<c:if test="${!empty categoryList}">
						<div>
							<ul class="w3-navbar w3-light- w3-round w3-small menu w3-card-4 "
								Style="width: 100%; margin-left: -2px; margin-top: -2px;">
						...
						<div class=top>
							<div class="carousel-inner" role="listbox">
								<div class="item active">
									<img
										src="<c:url value="resources/images/product/bookwall.jpg"></c:url>"
										alt="book">
							...
							<c:forEach items="${productList6}" var="product">
								<div class="col-xs-2 w3-animate-zoom">
									<div class="img">
										...
										<div class="desc w3-#6f2222" style="opacity: 0.9">
											<p>
	...
	<footer class="footer-distributed w3-card-4 w3-blue w3-margin-0"
		style="opacity: 0.9">
		<div class="footer-left" style="margin-top: 10px">
			...
			<p></p>
			<p>
				BIBLIO <i class="fa fa-copyright" aria-hidden="true"> 2016</i>
			</p>
			<p></p>
		...
		<div class="footer-center">
			...
			<div>
				...
				<p>
					<a href="mailto:biblio16@yahoo.co.in">biblio16@yahoo.co.in</a>
				</p>
			</div>
		</div>
		<div class="footer-right">
			<p class="footer-company-about">
				<span>About the company</span> <a href="http://www.secura.e-sim.org"
					title="Biblio, website template creation">BIBLIO</a> Inc is
				emerging online retailer in India & world,one of the fastest growing
				ecommerce Company. If you are bitten by the book-bug too, then there
				is a massive collection of books for you to read.We take pleasure of
				collecting all the books and place it online so that anyone can buy
				from any where. We strive to transform the way India shops and the
				way India sells.
			</p>
		</div>
	</footer>
