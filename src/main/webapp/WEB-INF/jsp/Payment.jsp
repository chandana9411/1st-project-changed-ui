...
<title>Payment</title>
<link href="<c:url value="/resources/css/credit.css" />"
	rel="stylesheet">
</head>
		...
		<div class="col-xs-4">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="row">
						<h3 class="panel-title " style="padding-left: 20px">Payment
							Details</h3>
					...
					<form action="pay" method="post">
								...
								<div class="form-group">
									...
									<div class="form-group">
										<input type="text" class="form-control input-sm"
											...
											pattern="^[123456789]\d{15}$"
											title="Enter valid 16 digit number" required />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-xs-7 col-md-7">
								<div class="form-group">
									<label for="cardExpiry"><span class="hidden-xs">Expiration</span><span
										...
										class="form-control input-sm" name="cardExpiry"
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<button class="btn btn-success btn-sm btn-block" type="submit">Make
									Payment</button>
